...
# Shared modules (`dataset`, `verifiers`, `comas`) live in trainers/co_rl and are
# imported from there rather than duplicated.
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "co_rl"))
...
def reward_correctness(completions, solution, **kwargs):
    ...
    CoMAS task routing (unsupervised, mirrors co_rl): `task`=="coding" ->
